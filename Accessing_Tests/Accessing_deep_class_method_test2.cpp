// Accessing_deep_class_method_test2
// -> Direct access via public members
// -> Duplicated methods (linked between each class' layer)
// -> LinearSpaces encapsulation in a dedicated array _spaces, within DataHandler class
//		|-> access granted by enumerate type (input_space, output_space) as indexes
